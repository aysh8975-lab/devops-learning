...
Physical — Cables, signals, and hardware transmission

Data Link — Frames, switches, and MAC addresses
...
Application — User-facing network services such as HTTP and DNS
...
Application — HTTP, DNS, SSH, and other application protocols
...
nginx.example.com → xx.xxx.xx.xxx
...
Stores verification information, metadata, and email security records
...
Calculate usable hosts for a traditional IPv4 subnet:

Usable hosts = total addresses - 2

Find the subnet block size.
...
Verify routing and internet connectivity.

Check DNS records and DNS resolution.
...
Download and securely store the .pem key file.

Configure a security group with:
...
NGINX page loading through the EC2 public IP

Cloudflare A record

NGINX page loading through the custom domain

Add the screenshots to the relevant GitHub project folder.
